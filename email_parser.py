...
def _attachments(msg):
    ...
    Includes the decoded raw bytes (`data`) alongside the existing metadata
    so downstream tools (e.g. a real antivirus scan) can inspect actual
    content, not just the filename and size.
    """
